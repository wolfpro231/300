...
const Token = "NTgxNDYwOTM0NTYwNzEwNjU3.XOfl3Q.K_NrOXXbRzeyRh0RV69XGsyqnz8" //هنا توكن البوت اللي بتشغل عليه الهاك
const x_x = ".2" //هنا تحط الامر اللي يشغل الهاك
const teext = "HackedBywolf" //هنا تحط وش تبي يكون اسم الرومات الكتابيه
const vooice = "HackedBywolf" //هنا تحط وش تبي يكون اسم الرومات الصوتيه
...
const spam = "HackedBywolf" //هنا تحط وش تبي رسالة السبام
const namee = "HackedBywolf" //هنا تحط وش تبي اسم السيرفر واسم البوت والبلاينق
const playing = "Muisc" //هنا تحط وش تبي يكون الستريمنق
